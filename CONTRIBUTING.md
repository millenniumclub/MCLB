Contributing to Millenniumclubcoin Core
============================

The Millenniumclubcoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to millenniumclubcoin-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the millenniumclubcoin unit tests or QA tests
...
The following applies to code changes to the Millenniumclubcoin Core project, and is not to be
confused with overall Millenniumclubcoin Network Protocol consensus changes.

Whether a pull request is merged into Millenniumclubcoin Core rests with the project merge
...
Patches that change Millenniumclubcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Millenniumclubcoin consensus, it must have been
...
The project leader is the release manager for each Millenniumclubcoin Core release.
