...
CONFIG_HEADER =  \
	$(top_builddir)/src/config/millenniumclubcoin-config.h
...
ACLOCAL = ${SHELL} /root/SourceCode/MCLB/source_code/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/SourceCode/MCLB/source_code/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/SourceCode/MCLB/source_code/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/SourceCode/MCLB/source_code/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /root/SourceCode/MCLB/source_code/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/SourceCode/MCLB/source_code
abs_srcdir = /root/SourceCode/MCLB/source_code
abs_top_builddir = /root/SourceCode/MCLB/source_code
abs_top_srcdir = /root/SourceCode/MCLB/source_code
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/SourceCode/MCLB/source_code/build-aux/install-sh
