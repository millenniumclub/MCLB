...
In order to support loading of multiple wallets in millenniumclubcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is millenniumclubcoin.cpp.
...
Changes to millenniumclubcoin.cpp
----------------------
millenniumclubcoin.cpp is the entry point into millenniumclubcoin-qt, and as such, will require some minor modifications to provide hooks for
