...
/* *** BEGIN OBFUSCATION MAGIC - MILLENNIUMCLUBCOIN **********
    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                adds up to a cost of 0.001 MILLENNIUMCLUBCOIN per transaction on average.
            */
            if (r <= 10) {
...
void CObfuscationPool::GetDenominationsToString(int nDenom, std::string& strDenom)
{
    ...
    //
    // bit 0 - 100MILLENNIUMCLUBCOIN+1 ( bit on if present )
    // bit 1 - 10MILLENNIUMCLUBCOIN+1
    // bit 2 - 1MILLENNIUMCLUBCOIN+1
    // bit 3 - .1MILLENNIUMCLUBCOIN+1
    // bit 3 - non-denom
