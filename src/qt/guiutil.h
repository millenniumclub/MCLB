...
/** Utility functions used by the Millenniumclubcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Millenniumclubcoin addresses in monospace font
...
// Parse "millenniumclubcoin:" URI into recipient object, return true on successful parsing
