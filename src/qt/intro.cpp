...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Millenniumclubcoin Core"),
     ...
     * override -datadir in the millenniumclubcoin.conf file in the default data directory
     * (to be consistent with millenniumclubcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
