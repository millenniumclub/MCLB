...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Millenniumclubcoin Core");
    ...
    QString copyrightTextMillenniumclubcoin = QChar(0xA9) +QString(tr("2018-2019")) + QString(tr(" The Millenniumclubcoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextMillenniumclubcoin);
