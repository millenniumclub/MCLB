                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received MCLB from zMCLB"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMCLB"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMCLB));
