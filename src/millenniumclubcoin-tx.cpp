...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Millenniumclubcoin Core millenniumclubcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  millenniumclubcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded millenniumclubcoin transaction") + "\n" +
                               "  millenniumclubcoin-tx [options] -create [commands]   " + _("Create hex-encoded millenniumclubcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded millenniumclubcoin transaction
